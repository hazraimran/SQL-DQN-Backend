...
export class PuzzleGenerator {
   ...
   */
  public generatePuzzlePrompt(role: number, difficulty: PuzzleDifficulty): string {
   ...
   */
  public evaluateUserQuery(userQuery: string, role: number, puzzlePrompt: string): boolean {
