...
const QNetwork_1 = require("./QNetwork");
const ReplayBuffer_1 = require("./ReplayBuffer");
class DQNAgent {
    constructor(inputDim, // dimension of (branchId + userFeatures)
    outputDim, // = numBranches
    replayCapacity, gamma = 0.99, epsilon = 1.0, epsilonMin = 0.01, epsilonDecay = 0.995, updateTargetSteps = 50, // frequency to update target network
    hiddenUnits = 16) {
        this.qNetwork = new QNetwork_1.QNetwork(inputDim, outputDim, hiddenUnits);
        this.targetNetwork = new QNetwork_1.QNetwork(inputDim, outputDim, hiddenUnits);
        // copy qNetwork weights to targetNetwork
        this.syncTargetNetwork();
        this.replayBuffer = new ReplayBuffer_1.ReplayBuffer(replayCapacity);
        this.gamma = gamma;
